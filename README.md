...
by the means of the command feed(). Three examples knowledge base of increasing size are available fon testing purposes: west25.txt, west104.txt, west303.txt.
